...
# def SelectPivotElement(a, r, c):
#     pivotElement = Position(r, c)
#     while pivotElement.column < len(a):
#         pivotElement.row = r
#         while pivotElement.row < len(a):
#             if a[pivotElement.row][pivotElement.column] == 0:
#                 pivotElement.row += 1
#                 continue
#             else:
#                 return pivotElement
...
# def SwapLines(a, b, r, pivotElement):
#     # a[pivot_element.column], a[pivot_element.row] = a[pivot_element.row], a[pivot_element.column]
#     # b[pivot_element.column], b[pivot_element.row] = b[pivot_element.row], b[pivot_element.column]
#     # used_rows[pivot_element.column], used_rows[pivot_element.row] = used_rows[pivot_element.row], used_rows[pivot_element.column]
#     # pivot_element.row = pivot_element.column
#     a[pivotElement.row], a[r] = a[r], a[pivotElement.row]
#     b[pivotElement.row], b[r] = b[r], b[pivotElement.row]
#     return pivotElement


# def ModifyRows(a, b, modifier, n, pos):
#     for i in range(n, len(a)):
#         a[pos][i] = a[pos][i] + modifier * a[n][i]
#     b[pos] = b[pos] + modifier * b[n]


# def ProcessPivotElement(a, b, pivotElement):
#     # Write your code here
#     n = pivotElement.row
#     assert n == pivotElement.column, "No solution"
#     divideBy = a[n][n]
#     for i in range(n, len(a)):
#         a[n][i] = a[n][i] / divideBy
#     b[n] = b[n] / divideBy
...
#         pivotElement = SelectPivotElement(a, r, c)
#         # SwapLines(a, b, used_rows, pivot_element)
#         pivotElement = SwapLines(a, b, r, pivotElement)
#         r, c = pivotElement.row, pivotElement.column
